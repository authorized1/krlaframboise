/**
 *  Polling Z-Wave Smoke CO Alarm v 1.0
 *
 *  Capabilities:
 *    Smoke Detector
 ...
 *    Battery
 *
 *  Author: Original "Z-Wave Smoke Alarm" by SmartThings
 *    Modified by Kevin LaFramboise (krlaframboise)
 *
 *  Changelog:
 *
 *    1.0 (06/04/2016)
 *      -	Added lastPoll attribute that gets updated
 *        when the device wakes up so that the Simple
 *        Device Viewer SmartApp can accurately report
...
metadata {
	definition (name: "Polling Z-Wave Smoke CO Alarm", namespace: "krlaframboise", author: "SmartThings, Kevin LaFramboise") {
...
def zwaveEvent(physicalgraph.zwave.commands.wakeupv1.WakeUpNotification cmd, results) {
	...
	results << createEvent(name:"lastPoll", value:new Date().time, displayed:false, isStateChange: true)
